        ...
        <div className="h-[400px] sm:h-[600px] lg:h-[800px] sticky top-[calc(100vh-400px)] sm:top-[calc(100vh-600px)] lg:top-[calc(100vh-800px)]">
          <div className="bg-neutral-900 py-4 sm:py-6 lg:py-8 px-4 sm:px-6 h-full w-full flex flex-col justify-between">
            <div className="flex shrink-0 gap-8 sm:gap-12 lg:gap-20">
              ...
              <div className="flex flex-col gap-1 sm:gap-2">
                <h3 className="mb-1 sm:mb-2 uppercase text-neutral-400 text-xs sm:text-sm">Добавки</h3>
                <a
                  href="#"
                  className="text-white hover:text-neutral-400 transition-colors duration-300 text-sm sm:text-base"
                >
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="mt-3 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                ...
                <p className="text-neutral-600 text-xs">{new Date().getFullYear()} SportFuel</p>
              </div>
            </div>
          </div>
        </div>
